...
using PupFoodFinds.Models.ViewModels;
...
namespace PupFoodFinds.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Summary() {
            ...
            ShoppingCartVM.OrderHeader.YearAndSection = ShoppingCartVM.OrderHeader.ApplicationUser.YearAndSection;
            ShoppingCartVM.OrderHeader.Program = ShoppingCartVM.OrderHeader.ApplicationUser.Program;
            ShoppingCartVM.OrderHeader.StudentNumber = ShoppingCartVM.OrderHeader.ApplicationUser.StudentNumber;
		...
		public IActionResult SummaryPOST()
		{
			...
			if (applicationUser.CompanyId.GetValueOrDefault() == 0)
			{
                //it is a regular customer account and need to captire payment
                //stripe logic
