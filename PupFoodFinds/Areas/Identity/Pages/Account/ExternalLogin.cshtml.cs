...
namespace PupFoodFinds.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("{FirstName} logged in with {LoginProvider} provider.", info.Principal.Identity.Name, info.LoginProvider);
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.CollegeDept=Input.CollegeDept;
                user.Program = Input.Program;
                user.YearAndSection = Input.YearAndSection;
